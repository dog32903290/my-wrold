...
private:
    ...
    void dumpAppSaveProof();
    void dumpAppStatusProof();
    void dumpWorkbenchStatusSurfaceProof();
    ...
    void updateWorkbenchRunSurface();
    ...
    std::array<juce::Label, 6> workbenchRunLabels;
