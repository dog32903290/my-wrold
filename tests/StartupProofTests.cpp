...
int main()
{
    ...
    expect (selectedTasks.size() == 8, "selected options should create eight tasks");
    ...
    expect (myworld::startupProofTasks (all).size() == 24, "all options should create every startup proof task");
