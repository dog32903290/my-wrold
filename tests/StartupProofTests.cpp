...
int main()
{
    ...
    expect (selectedTasks.size() == 9, "selected options should create nine tasks");
    ...
    expect (myworld::startupProofTasks (all).size() == 25, "all options should create every startup proof task");
